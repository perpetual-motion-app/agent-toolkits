import { JupiterGetNewPoolsToolkit } from './index';
import { JupiterPool } from './types';

async function main() {
  // Create an instance of the toolkit
  const toolkit = new JupiterGetNewPoolsToolkit();
  ...
  try {
    ...
    const stats = {
      ...
      organicScoreDistribution: {} as Record<string, number>
    };

    result.pools.forEach((pool: JupiterPool) => {
